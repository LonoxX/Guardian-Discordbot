...
module.exports = async (client, member, role) => {
  ...
  .setTitle(lang.messages.member.roleremove.title)
  .setColor(config.Bot.EmbedColor)
  .setThumbnail(member.user.displayAvatarURL({ dynamic: true }))
  .setDescription(lang.messages.member.roleremove.description.replace('{member}', member) .replace('{roleName}', role.name) )
