...
module.exports = async (client, guild, oldLevel, newLevel) => {
  ...
  .setTitle(lang.messages.boost.levelup.title)
  .setAuthor({ name: guild.name, iconURL: guild.iconURL({ dynamic: true }) })  
  .setDescription(lang.messages.boost.levelup.description .replace('{newBoostLevel}', newLevel.toString()))
  .addFields(lang.messages.boost.levelup.fields.map(field => ({
    name: field.name,
    value: field.value
